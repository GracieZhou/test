...
public class Utils {
    public static volatile boolean isNet = false;
    ...
    /**
     * @param if the network is not,call getNetworkState to get the network
     *            state again.
     * @return
     */
    ...
    public static boolean isNetConnected(Context context) {
        ...
        // NetworkInfo pppoeInfo =
        // manager.getNetworkInfo(ConnectivityManager.TYPE_PPPOE);

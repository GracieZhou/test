...
public final class SystemServer {
    ...
    // EosTek Patch Begin
    private static final String SCIFLY_SERVICE_CLASS =
            "com.android.server.scifly.SciflyService";
            
    private static final String CPE_SERVICE_CLASS =
            "com.android.server.cpe.CpeService";
    // EosTek Patch End
    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNetwork) {
                ...
                // EosTek Patch 
                mSystemServiceManager.startService(SCIFLY_SERVICE_CLASS);
                mSystemServiceManager.startService(CPE_SERVICE_CLASS);
                // EosTek Patch End
            }
            ...
            try {
                ...
                // Listen for camera station changes
                camera = new CameraObserver(context);
            } catch (Throwable e) {
                reportWtf("starting CameraObserver", e);
            }
            try {
                Slog.i(TAG, "Microphone Observer");
                // Listen for microphone station changes
                microphone = new MicrophoneObserver(context);
            } catch (Throwable e) {
                reportWtf("starting MicrophoneObserver", e);
            }
            // MStar Android Patch End
        ...
        mActivityManagerService.systemReady(new Runnable() {
            ...
            public void run() {
                ...
                // MStar Android Patch Begin
                Slog.i(TAG, "Startup TvService Apk....");
                ...
                // Detect camera/microphone
                try {
                    if (cameraF != null) cameraF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Camera Service ready", e);
                }
                try {
                    if (microphoneF != null) microphoneF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Microphone Service ready", e);
                }
                // MStar Android Patch End
                try {

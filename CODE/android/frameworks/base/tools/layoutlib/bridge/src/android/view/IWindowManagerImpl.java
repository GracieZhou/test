...
public class IWindowManagerImpl implements IWindowManager {
    ...
    // EosTek Patch Begin
    public void setAddViewEnabledForApk(String pkg, boolean enabled) throws RemoteException {
    }

    public List<String> getAddViewWhiteListForApk() throws RemoteException {
        return null;
    }

    public boolean areAddViewEnabledForApk(String pkg) throws RemoteException {
        return false;
    }
    // EosTek Patch End
}

...
public class MediaFile {
	...
	public static final int FILE_TYPE_ADTS =12;
	...
	// EosTek Patch Begin
	/**
	 * Change index of MIDI file types
	 *@hide
	 */
    public static final int FILE_TYPE_MID     = 17; // 11
    public static final int FILE_TYPE_SMF     = 18; // 12
    public static final int FILE_TYPE_IMY     = 19; // 13
	// EosTek Patch End
    ...
    // EosTek Patch Begin
    public static final int FILE_TYPE_EPUB          = 108;
	public static final int FILE_TYPE_APK          = 109;
    private static final int FIRST_DOCUMENT_TYPE = FILE_TYPE_TEXT;
    private static final int LAST_DOCUMENT_TYPE = FILE_TYPE_APK;
    // EosTek Patch End
    ...
    static {
		...
		addFileType("DOCX", FILE_TYPE_MS_WORD, "application/vnd.openxmlformats-officedocument.wordprocessingml.document", MtpConstants.FORMAT_MS_WORD_DOCUMENT);
		addFileType("XLSX", FILE_TYPE_MS_EXCEL, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", MtpConstants.FORMAT_MS_EXCEL_SPREADSHEET);
		addFileType("PPTX", FILE_TYPE_MS_POWERPOINT, "application/vnd.openxmlformats-officedocument.presentationml.presentation", MtpConstants.FORMAT_MS_POWERPOINT_PRESENTATION);
		addFileType("EPUB", FILE_TYPE_EPUB, "application/epub+zip");
		addFileType("ADTS", FILE_TYPE_ADTS, "audio/vnd.audio.adts");
    ...
    // EosTek Patch Begin
    public static boolean isDocumentType(int fileType) {
        return (fileType >= FIRST_DOCUMENT_TYPE &&
                fileType <= LAST_DOCUMENT_TYPE);
    }
    // EosTek Patch End
    ...
    public static boolean isMimeTypeMedia(String mimeType) {
        ...
        return isAudioFileType(fileType) || isVideoFileType(fileType)
                || isImageFileType(fileType) || isPlayListFileType(fileType) || isDocumentType(fileType);
    }
    // EosTek Patch End

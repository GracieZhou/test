        ...
        if (upgradeVersion < 114) {
            ...
            try {
                ...
                if (config_defaultIME != null && (!" ".equals(config_defaultIME))) {
                    Log.w(TAG, "config_defaultIME:" + config_defaultIME);
                    loadSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD, config_defaultIME);
                }

                String enabledIMEs = mContext.getResources().getString(R.string.enabled_input_methods);
                if (enabledIMEs != null && (!" ".equals(enabledIMEs))) {

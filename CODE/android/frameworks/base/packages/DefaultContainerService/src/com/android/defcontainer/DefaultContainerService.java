...
public class DefaultContainerService extends IntentService {
    ...
    private IMediaContainerService.Stub mBinder = new IMediaContainerService.Stub() {
        ...
        public String copyPackageToContainer(String packagePath, String containerId, String key,
		 ...
		 // EosTek Patch Begin
		 return copyPackageToContainerUsb(packagePath, containerId, key,
                isExternal, isForwardLocked, abiOverride, false);
		 }
		 
		 public String copyPackageToContainerUsb(String packagePath, String containerId, String key,
		 ...
		 // EosTek Patch End
            ...
            try {
                ...
                return copyPackageToContainerInner(pkg, handle, containerId, key, isExternal,
                        isForwardLocked, abiOverride, isUsb);
    ...
    private String copyPackageToContainerInner(PackageLite pkg, NativeLibraryHelper.Handle handle,
            ...
            String abiOverride, boolean isUsb) throws IOException {
	// EosTek Patch End
        ...
        final String newMountPath = PackageHelper.createSdDir(sizeBytes, newCid, key,
                Process.myUid(), isExternal, isUsb);
		// EosTek Patch End
        ...
        try {
			...
			// EosTek Patch Begin
            if (!PackageHelper.finalizeSdDir(newCid, isUsb)) {
			// EosTek Patch End
            ...
            // EosTek Patch Begin
                PackageHelper.unMountSdDir(newCid, isUsb);
            // EosTek Patch End
            }

        } catch (ErrnoException e) {
            // EosTek Patch Begin
            PackageHelper.destroySdDir(newCid, isUsb);
            // EosTek Patch End

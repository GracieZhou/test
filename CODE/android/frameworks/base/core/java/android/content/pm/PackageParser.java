...
public class PackageParser {
    ...
    */
	...
	// EosTek Patch Begin
    public final static int PARSE_ON_USB = 1<<10;
    // EosTek Patch End
    /**
    ...
    private Package parseBaseApk(Resources res, XmlResourceParser parser, int flags,
		...
		// EosTek Patch Begin
        if ((flags & PARSE_ON_USB) != 0) {
            pkg.applicationInfo.flags |= ApplicationInfo.FLAG_USB_STORAGE;
        }
        // EosTek Patch End
...
*/
    ...
    private Activity parseActivity(Package owner, Resources res,
        ...
        if (!receiver) {
            ...
            // MStar Android Patch Begin
            if (1 == SystemProperties.getInt("mstar.forcelandscape", 0)) {

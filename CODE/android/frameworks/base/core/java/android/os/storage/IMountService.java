...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            public int createSecureContainer(String id, int sizeMb, String fstype, String key,
                    int ownerUid, boolean external, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public int destroySecureContainer(String id, boolean force, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public int finalizeSecureContainer(String id, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public int unmountSecureContainer(String id, boolean force, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public int renameSecureContainer(String oldId, String newId, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public String getSecureContainerPath(String id, boolean isUsb) throws RemoteException {
            // EosTek Patch End
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
			...
			// EosTek Patch Begin
            public String[] getUsbSecureContainerList() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String[] _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getUsbSecureContainerList, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.createStringArray();
                } finally {
                    _reply.recycle();
            ...
            public boolean mountISO(String filename, IISOActionListener token, int nonce) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
            ...
            public String getISOFileMountPath(String filename) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(filename);
                    mRemote.transact(Stub.TRANSACTION_getISOFileMountPath, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
                    _reply.recycle();
            ...
            public boolean unmountISO(String filename, boolean force) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                boolean _result = false;
                try {
                    ...
                    _data.writeString(filename);
                    _data.writeInt((force ? 1 : 0));
                    mRemote.transact(Stub.TRANSACTION_unmountISO, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt() == 1;
                } finally {
                    _reply.recycle();
            ...
            public String[] getMountedISOFileList() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String[] _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getMountedISOFileList, _data, _reply, 0);
                    _reply.readException();
            ...
            public boolean mountSamba(String host, String shareDirectory, String mountPoint, String userName,
                              String password, boolean readOnly, boolean exec) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                boolean _result;
                try {
                    ...
                    _data.writeString(shareDirectory);
                    _data.writeString(mountPoint);
                    _data.writeString(userName);
                    _data.writeString(password);
                    _data.writeInt(readOnly ? 1 : 0);
                    _data.writeInt(exec ? 1 : 0);
                    mRemote.transact(Stub.TRANSACTION_mountSamba, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt() == 1;
                } finally {
                    _reply.recycle();
            ...
            public boolean unmountSamba(String mountPoint, boolean force) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                boolean _result;
                try {
                    ...
                    _data.writeString(mountPoint);
                    _data.writeInt(force ? 1 : 0);
                    mRemote.transact(Stub.TRANSACTION_unmountSamba, _data, _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt() == 1;
                } finally {
                    _reply.recycle();
        ...
        // MStar Android Patch Begin
        static final int TRANSACTION_mountISO = IBinder.FIRST_CALL_TRANSACTION + 43;

        static final int TRANSACTION_getISOFileMountPath = IBinder.FIRST_CALL_TRANSACTION + 44;

        static final int TRANSACTION_unmountISO = IBinder.FIRST_CALL_TRANSACTION + 45;

        static final int TRANSACTION_getMountedISOFileList = IBinder.FIRST_CALL_TRANSACTION + 46;

        static final int TRANSACTION_mountSamba = IBinder.FIRST_CALL_TRANSACTION + 47;

        static final int TRANSACTION_unmountSamba = IBinder.FIRST_CALL_TRANSACTION + 48;

        static final int TRANSACTION_getVolumeLabel = IBinder.FIRST_CALL_TRANSACTION + 49;

        static final int TRANSACTION_getVolumeUUID = IBinder.FIRST_CALL_TRANSACTION + 50;
        // MStar Android Patch End
		// EosTek Patch Begin
        static final int TRANSACTION_getUsbSecureContainerList = IBinder.FIRST_CALL_TRANSACTION + 51;
        // EosTek Patch Begin
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                case TRANSACTION_finalizeSecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = finalizeSecureContainer(id, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_destroySecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = destroySecureContainer(id, force, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_mountSecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = mountSecureContainer(id, key, ownerUid, readOnly, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_unmountSecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = unmountSecureContainer(id, force, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_renameSecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = renameSecureContainer(oldId, newId, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_getSecureContainerPath: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    String path = getSecureContainerPath(id, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                ...
                case TRANSACTION_fixPermissionsSecureContainer: {
                    ...
                    boolean isUsb;
                    isUsb = 0 != data.readInt();
                    int resultCode = fixPermissionsSecureContainer(id, gid, filename, isUsb);
                    // EosTek Patch End
                    reply.writeNoException();
                    reply.writeInt(resultCode);
                    return true;
                ...
                case TRANSACTION_mountISO: {
                    ...
                    String filename;
                    filename = data.readString();
                    IISOActionListener observer;
                    observer = IISOActionListener.Stub.asInterface(data.readStrongBinder());
                    int nonce = data.readInt();
                    boolean res;
                    res = mountISO(filename, observer, nonce);
                    reply.writeNoException();
                    reply.writeInt((res ? 1 : 0));
                    return true;
                }
                case TRANSACTION_getISOFileMountPath: {
                    data.enforceInterface(DESCRIPTOR);
                    String filename;
                    filename = data.readString();
                    String path = getISOFileMountPath(filename);
                    reply.writeNoException();
                    reply.writeString(path);
                    return true;
                }
                case TRANSACTION_unmountISO: {
                    data.enforceInterface(DESCRIPTOR);
                    String filename;
                    filename = data.readString();
                    boolean force;
                    force = 0 != data.readInt();
                    boolean res;
                    res = unmountISO(filename,force);
                    reply.writeNoException();
                    reply.writeInt((res ? 1 : 0));
                    return true;
                }
                case TRANSACTION_getMountedISOFileList: {
                    data.enforceInterface(DESCRIPTOR);
                    String [] paths = getMountedISOFileList();
                    reply.writeNoException();
                    reply.writeStringArray(paths);
                    return true;
                }
                case TRANSACTION_mountSamba: {
                    data.enforceInterface(DESCRIPTOR);
                    String host = data.readString();
                    String shareDirectory = data.readString();
                    String mountPoint = data.readString();
                    String userName = data.readString();
                    String password = data.readString();
                    boolean readOnly = data.readInt() == 1;
                    boolean exec = data.readInt() == 1;
                    boolean res = mountSamba(host, shareDirectory, mountPoint, userName,
                                            password, readOnly, exec);
                    reply.writeNoException();
                    reply.writeInt(res ? 1 : 0);
                    return true;
                }
                case TRANSACTION_unmountSamba: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint = data.readString();
                    boolean force = data.readInt() == 1;
                    boolean res = unmountSamba(mountPoint, force);
                    reply.writeNoException();
                    reply.writeInt(res ? 1 : 0);
                    return true;
                }
                case TRANSACTION_getVolumeLabel: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint = data.readString();
                    String volumeLabel = getVolumeLabel(mountPoint);
                    reply.writeNoException();
                    reply.writeString(volumeLabel);
                    return true;
                }
                case TRANSACTION_getVolumeUUID: {
                    data.enforceInterface(DESCRIPTOR);
                    String mountPoint = data.readString();
                    String volumeUUID = getVolumeUUID(mountPoint);
                    reply.writeNoException();
                ...
                // MStar Android Patch End
				// EosTek Patch Begin
                case TRANSACTION_getUsbSecureContainerList: {
                    data.enforceInterface(DESCRIPTOR);
                    String[] ids = getUsbSecureContainerList();
                    reply.writeNoException();
                    reply.writeStringArray(ids);
                    return true;
                }
    ...
    public int mountSecureContainer(String id, String key, int ownerUid, boolean readOnly)
            throws RemoteException;
	// EosTek Patch Begin
    public int mountSecureContainer(String id, String key, int ownerUid, boolean readOnly, boolean isUsb) throws RemoteException;
    // EosTek Patch End
     ...
     * Mount ISO file.
     * <p>
     * The {@link OnISOEvnetListener} registered with this call will be used to
     * receive the status event of the ISO file specified by filename. If failing
     * to mount the ISO file, the listener has no effect, you do not have to call
     * {@link MStorageManager#removeOnISOEvnetListener()}
     * to stop it.
     * @param filename the path to the ISO file
     * @param token a listener which is used to report the state of the ISO file by MountService
     * @param nonce identifier that is meaningful to the caller
     * @return whether the mount call was successfully or not
     */
    public boolean mountISO(String filename, IISOActionListener token,int nonce) throws RemoteException;

    /**
     * Get the mount path of the ISO file specified by filename
     * <p>
     * @param filename the full path of the ISO file
     * @return the mount path of the ISO file
     */
    public String getISOFileMountPath(String filename) throws RemoteException;

    /**
     * Unmount the ISO file specified by filename
     * <p>
     * @param filename the full path of the ISO file
     * @param force force to unmount the ISO file
     * @return whether the unmount call was successfully or not
     */
    public boolean unmountISO(String filename, boolean force) throws RemoteException;

    /**
     * List the mounted ISO files
     * <p>
     * @return the full paths of all the mounted ISO files
     */
    public String[] getMountedISOFileList() throws RemoteException;
     ...
     * Mount a samba.
     * <p>
     * You should make sure that the name of the mount directory is different
     * from others
     * @param host the ip address of the remote host
     * @param shareDirectory the share directory name
     * @param mountPoint the mount directory name
     * @param userName user name
     * @param password user password
     * @return the mount call was successfully or not
     */
    public boolean mountSamba(String host, String shareDirectory, String mountPoint, String userName,
                              String password, boolean readOnly, boolean exec) throws RemoteException;
     ...
     * <p>
     * @param mountPoint the mount directory name
     * @param force force to unmount the samba
     * @return whether the unmount call was successfully or not
     */
    public boolean unmountSamba(String mountPoint, boolean force) throws RemoteException;

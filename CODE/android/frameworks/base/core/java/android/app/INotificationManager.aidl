...
interface INotificationManager
{
    ...
    // EosTek Patch Begin
    void setNotificationsEnabledForApk(String pkg, boolean enabled);
    List<String> getNotificationsWhiteListForApk();
    boolean areNotificationsEnabledForApk(String pkg);
    // EosTek Patch End
}

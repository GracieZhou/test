...
public interface IActivityManager extends IInterface {
  ...
  // EosTek Patch Begin
   ...
   // EosTek Patch Begin
    int SET_AUTO_START_ENABLED_FOR_APK_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 186;
    int GET_AUTO_START_WHITE_LIST_FOR_APK_TRANSACTION  = IBinder.FIRST_CALL_TRANSACTION + 187;
    int KILL_ALL_BACKGROUND_APKS_TRANSACTION  = IBinder.FIRST_CALL_TRANSACTION + 188;
    // EosTek Patch End
}

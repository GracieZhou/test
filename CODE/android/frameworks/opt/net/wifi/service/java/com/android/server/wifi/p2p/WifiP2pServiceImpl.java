...
public final class WifiP2pServiceImpl extends IWifiP2pManager.Stub {
    ...
    private WifiP2pDevice mPeerDevice = new WifiP2pDevice();
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
               ...
               case WifiP2pManager.CREATE_GROUP:
                ...
                // MStar Android Patch Begin
                case WifiP2pManager.MCAST_LISTEN:
                    replyToMessage(message, WifiP2pManager.MCAST_LISTEN_FAILED,
                            WifiP2pManager.P2P_UNSUPPORTED);
                    break;
                // MStar Android Patch End
                default:
    ...
    class P2pEnabledState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                // MStar Android Patch Begin
                case WifiP2pManager.MCAST_LISTEN:
                    if (DBG) logd(getName() + " mcast listen mode");
                    if (mWifiNative.p2pListen(5)) {
                        replyToMessage(message, WifiP2pManager.MCAST_LISTEN_SUCCEEDED);
                    } else {
                        replyToMessage(message, WifiP2pManager.MCAST_LISTEN_FAILED);
                    }
                    break;
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiMonitor.P2P_PROV_DISC_SHOW_PIN_EVENT:
                    logd("cheny: inactive receive show pin");
                    if (mSavedPeerConfig == null) {
                        mSavedPeerConfig = new WifiP2pConfig();
                    }
                    provDisc = (WifiP2pProvDiscEvent) message.obj;
                    logd("provDisc :" + provDisc.toString());
                    mSavedPeerConfig.deviceAddress = provDisc.device.deviceAddress;
                    mSavedPeerConfig.wps.setup = WpsInfo.DISPLAY;
                    mSavedPeerConfig.wps.pin = provDisc.pin;
                    p2pConnectWithPinDisplay(mSavedPeerConfig);
                    notifyShowPinReceived(provDisc.pin);
                    break;
                // MStar Android Patch End
                case WifiP2pManager.CREATE_GROUP:
    ...
    class UserAuthorizingInviteRequestState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case PEER_CONNECTION_USER_ACCEPT:
                    // MStar Android Patch Begin
                    if (mPeers.get(mSavedPeerConfig.deviceAddress) != null) {
                        mPeerDevice = mPeers.get(mSavedPeerConfig.deviceAddress);
                        if (DBG) logd("UserAuthorizingInvitationState  mPeerDevice: " + mPeerDevice);
                    }
                    // MStar Android Patch End
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiMonitor.P2P_GROUP_STARTED_EVENT:
                    ...
                    // MStar Android Patch Begin
                    if (mPeers != null && mPeers.get(mGroup.getOwner().deviceAddress) != null) {
                        mPeerDevice = mPeers.get(mGroup.getOwner().deviceAddress);
                        if (DBG) logd("update mPeerDevice " + "mPeerDevice: " + mPeerDevice);
                    }
                    mReject = false;
                    // MStar Android Patch End
            ...
            switch (message.what) {
                case WifiMonitor.AP_STA_CONNECTED_EVENT:
                    ...
                    if (mPeers.get(deviceAddress) != null) {
                        mPeerDevice =  mPeers.get(deviceAddress);
                        if (DBG) logd("GroupCreatedState mPeerDevice: " + mPeerDevice);
                    }
                    // MStar Android Patch End
    ...
    private void sendP2pConnectionChangedBroadcast() {
        ...
        intent.putExtra(WifiP2pManager.EXTRA_WIFI_P2P_DEVICE, new WifiP2pDevice(mPeerDevice));
        // MStar Android Patch End
        mContext.sendStickyBroadcastAsUser(intent, UserHandle.ALL);
    ...
    // MStar Android Patch Begin
    private void notifyShowPinReceived(String pin) {
        logd("cheny: notifyShowPinReceived");
        Resources r = Resources.getSystem();
    ...
    // Eostek Patch Begin
        Uri CONTENT_URI = Uri.parse("content://com.eostek.scifly.provider/global");
        Cursor cursor = mContext.getContentResolver().query(CONTENT_URI, new String[] {
            "value"
        }, "key=?", new String[] {
            "device_name"
        }, null);
        ...
        if (DBG) {
            Slog.d(TAG, "devName : " + devName);
        }
        if (TextUtils.isEmpty(devName)) {
            devName = Settings.Global.getString(mContext.getContentResolver(),
            ...
            return "MCast_" + id.substring(0,4);
            // MStar Android Patch End
            }
            return devName;
        }

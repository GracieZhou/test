...
public class Constants {
    ...
    public static final String M805_UDISK_PATH = "/storage/external_storage/sd";

    public static final String UDISK_PATH = "/mnt/usb/";

    public static final String COLUMN_TASK_NUMBER = "task_number";

    public static final String COLUMN_SPEED_LIMITE = "speed_limite";

    public static final String COLUMN_SAVE_DIR = "save_dir_path";

    public static final String IS_DATA_CACHE_DIR = "is_data_cache";
    
    public static final String _ID = "_id";

    public static final Uri SETTING_URL = Uri.parse("content://com.android.providers.downloads.setting/setting");

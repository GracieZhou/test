...
public interface MediaServerController {
	 ...
	 * 
	 * @return protocol information list
	 * */
	...
	/**
	 * get resources information of server
	 * 
	 * @param id
	 * @param flag
	 * @param filter
	 * @param start_id
	 * @param requested_count
	 * @param sort_criteria
	 * @return
	...
	public void Authenticate(String pw) throws ActionUnsupportedException,
			HostUnreachableException, AuthenticateFailedException;

...
public class ProtocolInfo {
	...
	public ProtocolInfo(String protocol, String network, String content_format,
	...
	public String toString() {
		return "ProtocolInfo [protocol=" + protocol + ", network=" + network
				+ ", content_format=" + content_format + ", additional_info="
				+ additional_info + "]";
	}

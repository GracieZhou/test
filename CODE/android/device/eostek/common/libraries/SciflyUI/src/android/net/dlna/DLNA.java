...
public interface DLNA {
	 ...
	 * 
	 * @param ip
	 *            : Specifies the IP address binding��If the IP parameter is ""
	 *            or null, automatic selection of IP binding
	 * @param port
	 *            : Specifies the IP address binding��If the port is 0,
	 *            automatic selection of port binding
	 * @return true:succes��false:failed
	 */
	public boolean Initialize(String ip, int port);

	/**
	 * set description file of device
	 */
	...
	/**
	 * Create MediaRendererDevice
	 * 
	 * @return MediaRendererDevice object
	 */
	public MediaRendererDevice CreateMediaRendererDevice();

	/**
	 * Create MediaServerDevice
	 * 
	 * @return MediaServerDevice object
	 */
	...
	/**
	 * Get the already searched MediaRenderer device list
	 * 
	 * @return MediaRenderer device list
	 */
	public ArrayList<MediaRendererController> GetMediaRendererControllerList();

	/**
	 * Get the already searched MediaServer device list
	 * 
	 * @return MediaServer device list
	 */

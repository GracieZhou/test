...
public interface DiscCacheAware {
	...
	File get(String imageUri, String postfix);
	...
	boolean save(String imageUri, InputStream imageStream, String postfix, IoUtils.CopyListener listener) throws IOException;
	...
	boolean save(String imageUri, Bitmap bitmap, String postfix) throws IOException;
	...
	boolean remove(String imageUri, String postfix);

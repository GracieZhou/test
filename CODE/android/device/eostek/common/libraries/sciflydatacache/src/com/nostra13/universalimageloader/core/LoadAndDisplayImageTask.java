...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    public void run() {
        ...
        try {
            ...
            bmp = (Bitmap)configuration.memoryCache.get(memoryCacheKey);
        ...
        DisplayBitmapTask displayBitmapTask = new DisplayBitmapTask(bmp, imageLoadingInfo, engine, loadedFrom, syncLoading, handler);
    ...
    private Bitmap tryLoadBitmap() throws TaskCancelledException {
        Bitmap bitmap = null;
        try {
            File imageFile = configuration.diskCache.get(uri, postfix);

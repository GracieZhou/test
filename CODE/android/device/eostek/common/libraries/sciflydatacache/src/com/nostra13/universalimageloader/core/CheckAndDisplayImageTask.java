 ...
 * @since 1.3.1
 */
final class CheckAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    private static final String TAG = "CheckAndDisplayImageTask";
    ...
    public CheckAndDisplayImageTask(ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler) {
        this.engine = engine;
    ...
    public void run() {
        ...
        try {
            ...
            if (bmp != null && options.shouldPreProcess()) {
    ...
    private Bitmap tryLoadBitmap() throws TaskCancelledException {
        ...
        try {
            ...
            if (options.isCacheOnDisk() && tryCacheImageOnDisk()) {
                imageFile = configuration.diskCache.get(uri, postfix);
                if (imageFile != null) {
    ...
    private Bitmap decodeImage(String imageUri) throws IOException {
        ...
        ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey,
                imageUri, uri, targetSize, viewScaleType, getDownloader(), options);
    ...
    private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException {
        ...
        boolean saved = false;
        File targetFile = configuration.diskCache.get(uri, postfix);
        if (targetFile != null && targetFile.exists()) {
            ...
            if (bmp != null) {
                saved = configuration.diskCache.save(uri, bmp, postfix);
                bmp.recycle();
            }
        }
        return saved;

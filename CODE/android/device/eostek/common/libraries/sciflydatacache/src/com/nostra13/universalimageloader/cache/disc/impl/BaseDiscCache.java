...
public abstract class BaseDiscCache implements DiskCache {
	...
	public File get(String imageUri, String postfix) {
		return getFile(imageUri, postfix);
	}
	...
	@Override
	public boolean save(String imageUri, InputStream imageStream, String postfix, CopyListener listener)
			throws IOException {
		File imageFile = getFile(imageUri, postfix);
	...
	@Override
	public boolean save(String imageUri, Bitmap bitmap, String postfix)
			throws IOException {
		File imageFile = getFile(imageUri, postfix);
		File tmpFile = new File(imageFile.getAbsolutePath() + TEMP_IMAGE_POSTFIX);
		OutputStream os = new BufferedOutputStream(new FileOutputStream(tmpFile), bufferSize);
	...
	public boolean remove(String imageUri, String postfix) {
		return getFile(imageUri, postfix).delete();
	}
	...
	protected File getFile(String imageUri) {
		return getFile(imageUri, null);
	}

	protected File getFile(String imageUri, String postfix) {

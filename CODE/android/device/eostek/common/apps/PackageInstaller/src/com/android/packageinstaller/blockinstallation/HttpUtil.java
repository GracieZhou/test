...
public class HttpUtil {
	...
	private final static int NETWORK_CONNECTION_TIMEOUT = 10 * 1000;
	private final static int NETWORK_READ_DATA_TIMEOUT = 4 * 1000;
	...
	public static int getRespStatus(String url) {
        ...
        try {
            ...
            client.getParams().setIntParameter(HttpConnectionParams.SO_TIMEOUT, NETWORK_READ_DATA_TIMEOUT);

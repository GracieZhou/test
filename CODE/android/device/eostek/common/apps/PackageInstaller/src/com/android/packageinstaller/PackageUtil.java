...
public class PackageUtil {
     ...
     */
    public static ApplicationInfo getApplicationInfo(File sourcePath) throws IllegalArgumentException, ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
...
//        return pkg.applicationInfo;
     ...
     * @throws IllegalArgumentException 
     */
    public static PackageParser.Package getPackageInfo(File sourceFile) throws ClassNotFoundException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
...
//        return pkg;
        ...
        if (Build.VERSION.SDK_INT > 20) {
            ...
            DisplayMetrics metrics = new DisplayMetrics();
            metrics.setToDefaults();
            pkg = (PackageParser.Package)method.invoke(packageParser, sourceFile, sourceFile.getAbsolutePath(), metrics, 0);
        }
        return pkg;
    }
    ...
    public static boolean isSystemApk(Context context, String pkgName) {
        ...
        try {
            ...
            Log.d("PackageUtil", "[" + pkgName + "] is" + (res == false ? " NOT " : " ") + "a System-Signature Launcher!");
            return res;

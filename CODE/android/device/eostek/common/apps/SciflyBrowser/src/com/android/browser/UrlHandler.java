...
public class UrlHandler {
    ...
    /* package */ public final static String SCHEME_WTAI = "wtai://wp/";
    /* package */ public final static String SCHEME_WTAI_MC = "wtai://wp/mc;";
    /* package */ public final static String SCHEME_WTAI_SD = "wtai://wp/sd;";
    /* package */ public final static String SCHEME_WTAI_AP = "wtai://wp/ap;";
        ...
        if (mActivity.getPackageManager().resolveActivity(intent, 0) == null) {
            ...
            if (packagename != null) {
                intent = new Intent(Intent.ACTION_VIEW, Uri
                        .parse("market://search?q=pname:" + packagename));
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                WebViewHelper.getInstance(mActivity).onNewIntent(intent);
                // before leaving BrowserActivity, close the empty child tab.
                // If a new tab is created through JavaScript open to load this
                // url, we would like to close it as we will load this url in a
                // different Activity.

...
public interface PreferenceKeys {
    ...
    static final String PREF_INLINE_VIDEO = "inline_video";
     ...
     * Key for setting
     */
    static final String PREF_CLEAR_HISTORY = "clear_history";

    static final String PREF_CLEAR_CACHE = "clear_cache";

    static final String PREF_CLEAR_FORM_DATA = "clear_from_data";
    
    static final String PREF_CLEAR_PASSWORD = "clear_password";

    static final String PREF_CLEAR_COOKIE = "clear_cookie";

    static final String PREF_CANCLE_LOCAT_PERMISSION = "cancle_locat_permission";

    static final String PREF_SUGGEST_ETAG = "eTag_";
}

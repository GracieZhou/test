...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    private static final String SQL_WHERE_ACCOUNT_HAS_BOOKMARKS =
            ...
            + "  ) "
            + ")";
    public static int deleteId(String title){
        SQLiteDatabase helper =mOpenHelper.getWritableDatabase();
        int result = helper.delete(TABLE_BOOKMARKS, "title=?", new String[]{title});
        return result;
    }
}

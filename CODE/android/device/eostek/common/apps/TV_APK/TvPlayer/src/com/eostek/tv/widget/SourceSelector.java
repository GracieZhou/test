 ...
 */
public final class SourceSelector extends Drawable implements Animatable {
    ...
    public SourceSelector(View view, Drawable drawable) {
        mView = view;
        mDrawable = drawable;
        ...
        mAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (!bounds.equals(newBounds)) {
                    SourceSelector.super.setBounds(newBounds.left, newBounds.top,

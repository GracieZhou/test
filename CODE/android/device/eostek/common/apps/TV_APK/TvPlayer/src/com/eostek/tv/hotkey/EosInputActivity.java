...
import com.eostek.tv.widget.SourceSelector;
import com.mstar.android.MKeyEvent;
import com.mstar.android.tv.TvCommonManager;
/**
 * This Activity is not used now.
 * HotKey start from outside
 * @author laird
 *
 */
public class EosInputActivity extends Activity {
    ...
    private SourceSelector mAnimatedSelector;
    ...
    // the good keycodes to start factory menu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAnimatedSelector = new SourceSelector(selector, mSourceGridView.getSelector());
        mAnimatedSelector.setLeftOffset(getResources().getInteger(R.integer.input_select_left_off));
        mAnimatedSelector.setTopOffset(getResources().getInteger(R.integer.input_selector_margintop));
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                case KeyEvent.KEYCODE_TV_INPUT:
                    // if the current activity is EosInputActivity,just finish
                    // the Activity
                    String activityName = UtilsTools.getCurTopActivityName(EosInputActivity.this);
    ...
    private void setListener() {
        ...
        mSourceGridView.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                mHandler.sendEmptyMessageDelayed(MSG_UPDATE_IMG, 200);
            }
    ...
    private void setInputSource(int position) {
        ...
        intent.putExtra(Constants.HOTKEY_EXTRA_KEY, curSource);

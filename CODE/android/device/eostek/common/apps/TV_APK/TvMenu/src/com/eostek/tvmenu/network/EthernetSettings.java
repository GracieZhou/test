...
//        mContext.unregisterReceiver(mEthStateReceiver);
    ...
    public boolean isAutoIP() {
        if (mIpConfiguration.getIpAssignment().equals(IpAssignment.DHCP)) {
            Log.e("test", "isAutoIP = true ");
            return true;
        } else {
            Log.e("test", "isAutoIP = false ");
            return false;
        }
    }
...
//                /*
//                 * Added by gerard.jiang for "0390962" in 2013/05/07.
//                 * Set IP to default when disconnect the Ethernet.
//                 */
//                mEthernetHolder.refreshNetworkInfo(DEFAULT_IP, DEFAULT_IP, DEFAULT_IP, DEFAULT_IP, DEFAULT_IP);
//                /***** Ended by gerard.jiang 2013/05/07 *****/
//                break;
...
//    }
       ...
       private void saveEthernetConfig(boolean auto) {
        ...
        Log.e("test", "mEthernetHolder.getEthernetV4Address() ip =" + ip);
        Log.e("test", "mEthernetHolder.getEthernetV4Address() subnet =" + subnet);
        Log.e("test", "mEthernetHolder.getEthernetV4Address() gateway =" + gateway);
        Log.e("test", "mEthernetHolder.getEthernetV4Address() dns =" + dns);
        Log.e("test", "hasIpSettings== =" + auto);
        ...
        if (auto) {
            ...
            Log.e("test", "setStaticIpConfiguration(staticConfig)");
            ...
            staticConfig.dnsServers.add((Inet4Address) NetworkUtils.numericToInetAddress(dns));
//            staticConfig.dnsServers.add((Inet4Address) NetworkUtils.numericToInetAddress(dns2));
            ...
            Log.e("test", "staticConfig.ipAddress =" + staticConfig.ipAddress);
            Log.e("test", "staticConfig.gateway =" + staticConfig.gateway);
            Log.e("test", "staticConfig.dnsServers =" + staticConfig.dnsServers);
        }

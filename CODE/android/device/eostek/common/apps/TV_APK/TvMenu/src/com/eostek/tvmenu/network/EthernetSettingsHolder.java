...
public class EthernetSettingsHolder {
    ...
    public void refreshNetworkInfo(String ip, String netmask, String gateway, String dns1,
        ...
        Log.d(TAG, "ip, " + ip + " netmask, " + netmask + " gateway, " + gateway + " dns1, " + dns1
                + " dns2, " + dns2);
        if (ip != null) {
            String[] ips = NetworkTools.resolutionIP(ip);
        ...
        if (netmask != null) {
            String[] masks = NetworkTools.resolutionIP(netmask);
        ...
        if (gateway != null) {
            String[] defaultWays = NetworkTools.resolutionIP(gateway);
        ...
        if (dns1 != null) {
            String[] firstdnss = NetworkTools.resolutionIP(dns1);
        ...
        if (dns2 != null) {
            String[] secdnss = NetworkTools.resolutionIP(dns2);

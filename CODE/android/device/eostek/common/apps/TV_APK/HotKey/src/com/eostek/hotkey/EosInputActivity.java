...
public class EosInputActivity extends Activity {
     ...
     */
    private void initCurInputSourceImg() {
        ...
        switch (curSourceId) {
            ...
            case TvCommonManager.INPUT_SOURCE_HDMI:
                mInputImgs[2] = R.drawable.tv_signal_hdmi1_selected; // 0
                mCurIndex = 2;
                break;
            case TvCommonManager.INPUT_SOURCE_HDMI2:
                mInputImgs[3] = R.drawable.tv_signal_hdmi2_selected; // 1
                mCurIndex = 3;
                break;

...
public InputMethodSettingsAdapter(InputMethodSettingsActivity activity,ArrayList<HashMap<String,Object>> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int inputMethodId=mActivity.getmLogic().getCurrentInputMethodId();
        if(inputMethodId==position){

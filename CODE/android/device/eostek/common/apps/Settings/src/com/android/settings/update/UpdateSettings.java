...
public class UpdateSettings extends SettingsPreferenceFragment{
    private static final String TAG = "UpdateSettings";

    private static final int DIALOG_NET_UPDATE = 0;

    private static final int DIALOG_LOCAL_UPDATE = 1;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (KEY_NET_UPDATE.equals(preference.getKey())) {
        	 Intent intent = new Intent();
        	 intent.setClass(getActivity(), SystemNetUpdateActivity.class);
    ...
    public Dialog onCreateDialog(int dialogId) {
        switch (dialogId) {
            case DIALOG_NET_UPDATE:
                break;
            case DIALOG_LOCAL_UPDATE:
            	break;
            default:
                break;
        }

...
public class SettingsPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    /**
     * Override this if you want to show a help item in the menu, by returning
     * the resource id.
     * 
            ...
            if (savedInstanceState != null) {
                ...
                if (mParentFragmentId > -1) {
                    ...
                    if (!(mParentFragment instanceof DialogCreatable)) {
                        throw new IllegalArgumentException((mParentFragment != null ? mParentFragment.getClass()
                                .getName() : mParentFragmentId) + " must implement " + DialogCreatable.class.getName());
                    }
                }

...
import com.android.settings.util.MD5Tools;

/**
 * This class is get the Update JSONData.
 * 
 * @author king
 */
public class JSONData {
    ...
    private static final String JSON_URL = SystemProperties.get("ro.scifly.service.url",
    ...
    private static String getJsonString(JSONObject json) {
        ...
        String tcip = bbNumber
                + "_"
                + MD5Tools
                        .calcMD5(bbNumber + JSON_URL + json + System.currentTimeMillis() + System.currentTimeMillis())
                + "_"
                + System.currentTimeMillis()
                + "_"
                + MD5Tools.calcMD5(bbNumber + JSON_URL + json + Build.DISPLAY.toString().split(" ")[0]
                        + System.currentTimeMillis());
        ...
        try {
            ...
            Log.d(TAG, "JSONData: ServerUrl=" + JSON_URL);
            httpUrlConnection = (HttpURLConnection) url.openConnection();
            httpUrlConnection.setRequestProperty("Content-Type", "text/json; charset=UTF-8");
            httpUrlConnection.setRequestProperty("Ttag", Build.DISPLAY.toString().split(" ")[0] + "_0.0.3490.1_1");
            ...
            Log.d(TAG, "JSONData: response code, " + httpUrlConnection.getResponseCode());
            inputStream = httpUrlConnection.getInputStream();
            Log.d(TAG, "JSONData: inputStream {" + inputStream.toString() + "}");
    ...
    @SuppressLint("NewApi")
    public static String getUpgradeInfo(Context mContext, String type) {
        ...
        try {
            ...
            json.put("devId", Device.getDeviceId(mContext));
            json.put("mac", devMac);
            json.put("type", type);

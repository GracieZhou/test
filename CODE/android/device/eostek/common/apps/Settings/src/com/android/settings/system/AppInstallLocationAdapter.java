...
public class AppInstallLocationAdapter extends BaseAdapter {
    ...
    public AppInstallLocationAdapter(AppInstallLocationActivity activity, ArrayList<HashMap<String, Object>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int locationId = mActivity.getmLogic().getDefaultInstallLocationId();

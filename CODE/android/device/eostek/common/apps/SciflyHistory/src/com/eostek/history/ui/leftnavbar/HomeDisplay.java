...
class HomeDisplay {
    ...
    enum Mode {
        ICON, LOGO, BOTH // Icon when collapsed, logo when expanded.
    }
    ...
    private void updateImage() {
        ...
        boolean useTitle = (mMode == Mode.BOTH && mExpanded && useIcon);
        mView.findViewById(R.id.home_title).setVisibility(useTitle ? View.VISIBLE : View.GONE);
    }

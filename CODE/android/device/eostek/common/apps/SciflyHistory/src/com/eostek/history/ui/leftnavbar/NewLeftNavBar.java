 ...
 */
public class NewLeftNavBar extends ActionBar {
    ...
    public NewLeftNavBar(Activity activity) {
        initialize(activity.getWindow());
    }

    public NewLeftNavBar(Dialog dialog) {
        initialize(dialog.getWindow());
    }
    ...
    private void initialize(Window window) {
        ...
        // mContent = decor.findViewById(R.id.qingyu_and_android_layer);
    ...
    // FIXME
    // @Override
    // public void addTab(Tab tab,float position) {
    // }

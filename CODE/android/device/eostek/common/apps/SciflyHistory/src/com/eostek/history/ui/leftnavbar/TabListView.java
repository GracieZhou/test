...
public class TabListView extends ListView {
    ...
    /**
     * Sets the highlighted item which will receive focus whenever this list
     * gains focus.
     */
    ...
    /**
     * Whenever the geometry of the list changes, focus gets cleared. This is
     * problematic when the list gets expanded. Instead of letting the focus go
     * away, it simply gets reset slightly later.
     */
    @Override

...
public class TitleBarView extends RelativeLayout {
    ...
    public TitleBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, new int[] {
                android.R.attr.windowTitleStyle, android.R.attr.defaultValue
        });
        ...
        if (mIsLegacy) {
            ...
            a.recycle();
            a = context.obtainStyledAttributes(null, new int[] {
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() == 0) {
            ...
            LayoutInflater.from(getContext()).inflate(R.layout.lib_title_bar, this, true);
        }
        ...
        if (mCircularProgress != null) {
            mCircularProgress.setIndeterminate(true); // Cannot be done in
                                                      // XML...
        }

...
class TabDisplay {
    ...
    private final class TabAdapter extends ArrayAdapter<TabImpl> {
        ...
        /**
         * The currently selected tab, or {@code TabDisplay#NONE} if none is
         * selected.
         */
        private TabImpl mSelection;

        /**
         * {@code true} if selection changes should trigger a callback and any
         * visual change; otherwise the selection is just remembered.
         */
        private boolean mIsSelectionActive;

        /**
         * When selection is not active, this simply remembers which tab was
         * selected.
         */
        ...
        public void remove(TabImpl tab) {
            // Need to make sure custom views are properly removed from their
            // parent.
        ...
        /**
         * Updates the tab objects so that they correctly report their position
         * in the list.
         * 
         * @param allInvalid {@code true} to set the position as "invalid" on
         *            all tabs
         */

...
/**
 * Container for tabs, responsible for handling events and setting the correct
 * state.
 */
class TabFrame extends LinearLayout {
    ...
    public void setSelected(boolean selected) {
        // No-op: the selected state is used to show that the tab is selected in
        // the logical sense,
        // whereas ListView would attempt to use that state to show the tab as
        // "highlighted" - we
        // use focus for that.
    }
     ...
     * <p>
     * For regular tabs, this will simply reveal the tab's title and mark the
     * icon as activated. For custom tabs, this will set their "activated"
     * state.
     * 
    ...
    public void configureCustom(View content) {
        ...
        // Prevent the content from receiving events, but let it reflect the
        // correct state.

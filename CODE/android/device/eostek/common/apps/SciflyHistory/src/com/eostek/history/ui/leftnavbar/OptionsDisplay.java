...
class OptionsDisplay {
    ...
    private void createView(ViewGroup parent, TypedArray attributes) {
        ...
        configureOption(menuOption, mContext.getResources().getString(R.string.leftnav_bar_option_label), true);
    ...
    /**
     * Forces a view to duplicate its parent state, working around a bug whereby
     * the attribute only works if set before the view is added to its parent.
     */

 ...
 * <p>
 * {@code select()} is left unimplemented so that the entity managing tabs can
 * define the proper selection flow.
 */
abstract class TabImpl extends Tab {
    ...
    public Tab setContentDescription(int resId) {
        return setContentDescription(this.mContext.getResources().getText(resId));
    }

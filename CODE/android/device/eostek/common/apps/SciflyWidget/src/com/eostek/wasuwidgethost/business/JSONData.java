...
import com.eostek.wasuwidgethost.util.MD5Tools;
...
public final class JSONData {
    ...
    private static String getJsonString(JSONObject json) {
        ...
        String tcip = bbNumber
                ...
                + MD5Tools.calcMD5(bbNumber + JSON_URL + json
                        + (String) (Build.DISPLAY).split(" ")[0] + System.currentTimeMillis());
        ...
        try {
            ...
            httpUrlConnection.setRequestProperty("Ttag", (String) (Build.DISPLAY).split(" ")[0]
                    + "_0.0.3490.1_1");
    ...
    public static String getUpgradeInfo(Context mContext, String type) {
        ...
        try {
            ...
            json.put("lver", (String) Build.VERSION.INCREMENTAL);

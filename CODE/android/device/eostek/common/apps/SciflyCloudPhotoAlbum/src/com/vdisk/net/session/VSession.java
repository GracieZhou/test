...
public interface VSession {
    ...
    /**
     * Will be called every time a request is made to VDisk, in case the proxy
     * changes between requests. Return null if you do not want to use a proxy,
     * or a {@link ProxyInfo} object with a host and optionally a port set.
     */
    public ProxyInfo getProxyInfo();

    /**
     * Will be called every time a request is made to VDisk, in case you want to
     * use a new client every time. However, it's highly recommended to create a
     * client once and reuse it to take advantage of connection reuse.
     */

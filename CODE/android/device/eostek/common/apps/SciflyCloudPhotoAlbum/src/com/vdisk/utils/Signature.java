...
public class Signature {
    ...
    private static byte[] getHmacSHA1(String src, AppKeyPair appKeyPair) throws NoSuchAlgorithmException,
            UnsupportedEncodingException, InvalidKeyException {
        Mac mac = Mac.getInstance(KEY_MAC);
        SecretKeySpec secret = new SecretKeySpec(appKeyPair.secret.getBytes("UTF-8"), mac.getAlgorithm());
        mac.init(secret);

...
public class Token implements Serializable {
    ...
    /**
     * AccessToken,用户验证的唯一标识. The unique identifier of the user authentication
     */
    ...
    /**
     * token的有效期，在此时间点之前，token都有效,是一个时间戳,单位是秒. Expire time of token. Token is
     * available before this time. It is a time stamp, its unit is seconds.
     */
    public String mExpiresIn = "";

    /**
     * 用户的微博uid User's Weibo uid
     */
    public String mUid = "";

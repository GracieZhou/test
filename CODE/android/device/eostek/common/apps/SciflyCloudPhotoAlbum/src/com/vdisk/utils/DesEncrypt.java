 ...
 * 使用时从SharedPreferences读取出来，通过此方法解密后使用. DES encryption and decryption
 * algorithm. This method is used to encrypt VDisk token and save it in
 * SharedPreferences. Read it from SharedPreferences and decrypt it to use.
 * 
 * @author sina
 */
public class DesEncrypt {
    ...
    public DesEncrypt(String IMEI, AppKeyPair appKeyPair) {
        this.PASSWORD = "com.sina.vdisk.security.password.d7af3082d815945ff47ae58647bd9436" + IMEI + appKeyPair.key
                + appKeyPair.secret;
    }

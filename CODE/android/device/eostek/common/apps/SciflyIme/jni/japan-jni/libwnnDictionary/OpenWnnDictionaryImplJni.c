 ...
 */
#include "com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni.h"
  ...
  (JNIEnv *env, jobject obj, jlong wnnWork, jint operation, jint order, jstring keyString)
{
	...
	if( !( operation == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_SEARCH_EXACT ||
           operation == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_SEARCH_PREFIX ||
           operation == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_SEARCH_LINK ) ||
		!( order == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_ORDER_BY_FREQUENCY ||
           order == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_ORDER_BY_KEY ) ||
		   keyString == NULL ) {
		/* If a invalid parameter was specified, return an error code */
	...
	if( work != NULL ) {
		...
		if( convertStringToNjChar( env, work->keyString, keyString, NJ_MAX_LEN ) >= 0 ) {
            ...
            if( operation == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_SEARCH_LINK ) {
  ...
  (JNIEnv *env, jclass obj, jlong wnnWork, jint approxPattern)
{
	...
	if( !( approxPattern == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_TOUPPER ||
		   approxPattern == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_TOLOWER ||
		   approxPattern == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_QWERTY_NEAR ||
		   approxPattern == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_APPROX_PATTERN_EN_QWERTY_NEAR_UPPER ||
		   approxPattern == com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_APPROX_PATTERN_JAJP_12KEY_NORMAL ) ) {
		/* If a invalid parameter was specified, return an error code */
		return NJ_SET_ERR_VAL(NJ_FUNC_JNI_SET_APPROX_PATTERN, NJ_ERR_INVALID_PARAM);
	}
  ...
  (JNIEnv *env, jclass obj, jlong wnnWork, jint type)
{
	...
	if( work != NULL ) {
        switch( type ) {
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_V1:
            type = NJ_HINSI_V1_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_V2:
            type = NJ_HINSI_V2_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_V3:
            type = NJ_HINSI_V3_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_BUNTOU:
    		/* No part of speech is defined at this type */
            return 0;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_TANKANJI:
            type = NJ_HINSI_TANKANJI_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_SUUJI:
    		/* No part of speech is defined at this type */
            return 0;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_MEISI:
            type = NJ_HINSI_MEISI_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_JINMEI:
            type = NJ_HINSI_JINMEI_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_CHIMEI:
            type = NJ_HINSI_CHIMEI_F;
            break;
        case com_android_inputmethod_openwnn_OpenWnnDictionaryImplJni_POS_TYPE_KIGOU:

...
public class Romkan implements LetterConverter {
    ...
    public  static final HashMap<String, String> romkanTable = new HashMap<String, String>() {{
    ...
    public boolean convert(ComposingText text) {
        ...
        while (start < MAX_LENGTH) {
            ...
            Log.d("raymond", "match------------------"+match);
            Log.d("raymond", "key.toString().toLowerCase()------------------"+key.toString().toLowerCase());
            if (match != null) {
                if (upper) {

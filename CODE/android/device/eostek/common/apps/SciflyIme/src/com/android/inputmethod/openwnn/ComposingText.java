...
package com.android.inputmethod.openwnn;
...
public class ComposingText {
    ...
    private static ArrayList<StrSegment>[] mStringLayer;
    /** Cursor position */
    ...
    public void deleteChar(){
       ArrayList<StrSegment> strUplayer0 = mStringLayer[0];
       ArrayList<StrSegment> strUplayer1 = mStringLayer[1];
//       if(mStringLayer[0].size()>= 1){
//           Log.d("raymond", "mStringLayer[0]"+mStringLayer[0].toString());
//           StringBuffer buf = new StringBuffer();
//           ArrayList<StrSegment> strLayer = mStringLayer[0];
//           
//           for (int i = 0; i <= mStringLayer[0].size()-1; i++) {
//               StrSegment ss = strLayer.get(i);
//               buf.append(ss.string);
//           }
//           strUplayer0.remove(mStringLayer[0].size()-1);
//           Log.d("raymond", "mStringLayer[0]"+buf.toString());
//       }
       if(mStringLayer[1].size() != 0 ){
       Log.d("raymond", "mStringLayer[1]"+mStringLayer[1].get(mStringLayer[1].size()-1).string);
       strUplayer1.remove(mStringLayer[1].size()-1);
       if(mStringLayer[1].size() !=1){
       Log.d("raymond", "mStringLayer[1]"+mStringLayer[1].get(mStringLayer[1].size()-1).string);
       }
       Log.d("raymond", "mStringLayer[1]"+mStringLayer[1].size());
       }
       if(mStringLayer[0].size() != 0){
           Log.d("raymond", "mStringLayer[0]"+mStringLayer[0].get(mStringLayer[0].size()-1).string);
           strUplayer0.remove(mStringLayer[0].size()-1);
           if(mStringLayer[0].size() != 1){
           Log.d("raymond", "mStringLayer[0]"+mStringLayer[0].get(mStringLayer[0].size()-1).string);
           }
           Log.d("raymond", "mStringLayer[0]"+mStringLayer[0].size());
           }
    ...
    public int delete(int layer, boolean rightside) {
        ...
        if (!rightside && cursor > 0) {
            Log.d("raymond"," deleteStrSegment(layer, cursor-1, cursor-1);" );

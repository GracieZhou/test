...
class CangjieTable {
    ...
    private static final HashMap<Character, Integer> letters = new HashMap<Character, Integer>();
    static {
        int i = 1;
        letters.put('\u65e5', i++);
        letters.put('\u6708', i++);
    ...
    /**
     * Returns {@code true} only if the given character is a valid cangjie
     * letter.
     */
    ...
    /**
     * Returns the primary index calculated by the first and last letter of the
     * given cangjie code.
     * 
    ...
    static int getPrimaryIndex(CharSequence code) {
        ...
        // The first letter cannot be absent in the code; therefore, the
        // numerical

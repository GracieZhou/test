...
public class TwoWayGridView extends TwoWayAbsListView {
     ...
     * 
     * @param position Index (starting at 0) of the data item to be selected. If
     *            in touch mode, the item will not be selected but it will still
     ...
     * the grid.
     * 
     * @param horizontalSpacing The amount of horizontal space between items, in
     *            pixels.
     ...
     * grid.
     * 
     * @param verticalSpacing The amount of vertical space between items, in
     *            pixels.
    ...
    private abstract class GridBuilder {
        ...
        protected abstract View makeAndAddView(int position, int y, boolean flow, int childrenLeft, boolean selected,
                int where);
    ...
    private class VerticalGridBuilder extends GridBuilder {
        ...
        protected View makeAndAddView(int position, int y, boolean flow, int childrenLeft, boolean selected, int where) {
            View child;
            if (DEBUG)
                Debug.d(TAG, "makeAndAddView() - start - position: " + position + " mFirstPosition: " + mFirstPosition);
            if (!mDataChanged) {
                ...
                if (child != null) {
                    ...
                    if (DEBUG)
                        Debug.d(TAG, "makeAndAddView() - end - position: " + position + "reused a view");
                    return child;
                }
            }
            ...
            if (DEBUG)
                Debug.d(TAG, "makeAndAddView() - end - position: " + position + "did NOT reuse a view - scrap: "
                        + mIsScrap[0]);
            return child;
        }
        ...
        protected void fillGap(boolean down) {
            ...
            if (down) {
                final int startOffset = count > 0 ? getChildAt(count - 1).getBottom() + verticalSpacing
                        : getListPaddingTop();
                ...
                final int startOffset = count > 0 ? getChildAt(0).getTop() - verticalSpacing : getHeight()
         ...
         * @param nextTop The location where the top of the item associated with
         *            pos should be drawn
        ...
        private View fillDown(int pos, int nextTop) {
            if (DEBUG)
                Debug.d(TAG, "fillDown() pos: " + pos + " nextTop: " + nextTop + " mFirstPosition: " + mFirstPosition);
        ...
        private View makeRow(int startPos, int y, boolean flow) {
            if (DEBUG)
                Debug.d(TAG, "makeRow() startPos: " + startPos + " y: " + y + " flow: " + flow + " mFirstPosition: "
                        + mFirstPosition);
         ...
         * 
         * @param pos The first position to put in the list
         * @param nextBottom The location where the bottom of the item
         *            associated with pos should be drawn
         * @return The view that is currently selected
         */
        private View fillUp(int pos, int nextBottom) {
            if (DEBUG)
                Debug.d(TAG, "fillLeft() pos: " + pos + " nextBottom: " + nextBottom + " mFirstPosition: "
                        + mFirstPosition);
            View selectedView = null;
        ...
        private View fillFromTop(int nextTop) {
            if (DEBUG)
                Debug.d(TAG, "fillFromTop() nextLeft: " + nextTop + " mFirstPosition: " + mFirstPosition);
        ...
        private View fillFromBottom(int lastPosition, int nextBottom) {
            if (DEBUG)
                Debug.d(TAG, "fillFromBotom() lastPosition: " + lastPosition + " nextBottom: " + nextBottom
        ...
        private View fillSelection(int childrenTop, int childrenBottom) {
            if (DEBUG)
                Debug.d(TAG, "fillSelection() childrenTop: " + childrenTop + " childrenBottom: " + childrenBottom
                        + " mFirstPosition: " + mFirstPosition);
        ...
        private View fillSpecific(int position, int top) {
            if (DEBUG)
                Debug.d(TAG, "fillSpecific() position: " + position + " top: " + top + " mFirstPosition: "
                        + mFirstPosition);
            final int numColumns = mNumColumns;
        ...
        private void correctTooHigh(int numColumns, int verticalSpacing, int childCount) {
            if (DEBUG)
                Debug.d(TAG, "correctTooLeft() numColumns: " + numColumns + " verticalSpacing: " + verticalSpacing
                        + " mFirstPosition: " + mFirstPosition);
        ...
        private void correctTooLow(int numColumns, int verticalSpacing, int childCount) {
            if (DEBUG)
                Debug.d(TAG, "correctTooLow() numColumns: " + numColumns + " verticalSpacing: " + verticalSpacing
                        + " mFirstPosition: " + mFirstPosition);
        ...
        private View fillFromSelection(int selectedTop, int childrenTop, int childrenBottom) {
            if (DEBUG)
                Debug.d(TAG, "fillFromSelection() selectedTop: " + selectedTop + " childrenTop: " + childrenTop
                        + " childrenBottom: " + childrenBottom + " mFirstPosition: " + mFirstPosition);
            final int fadingEdgeLength = getVerticalFadingEdgeLength();
            final int selectedPosition = mSelectedPosition;
            final int numColumns = mNumColumns;
            final int verticalSpacing = mVerticalSpacing;
         ...
         * @param fadingEdgeLength Length of the fading edge in pixels, if
         *            present
         ...
         * 
         * @param childInSelectedRow A child in the row that contains the
         *            selection
         * @param topSelectionPixel The topmost pixel we can draw the selection
         *            into
        ...
        private View moveSelection(int delta, int childrenTop, int childrenBottom) {
            if (DEBUG)
                Debug.d(TAG, "moveSelection() delta: " + delta + " childrenTop: " + childrenTop + " childrenBottom: "
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (DEBUG)
                Debug.d(TAG, "vertical onMeasure heightMode: " + heightMode);
            ...
            if (DEBUG)
                Debug.d(TAG, "Vertical onMeasure widthSize: " + widthSize + " heightSize: " + heightSize);
        }
         ...
         * @param childrenLeft Left edge where children should be positioned
         * @param selected Is this position selected?
         * @param recycled Has this view been pulled from the recycle bin? If so
         *            it does not need to be remeasured.
         ...
         * 
         * @param direction either {@link View#FOCUS_LEFT},
         *            {@link View#FOCUS_RIGHT}, {@link View#FOCUS_UP} or
         ...
         * @param direction The direction, one of {FOCUS_UP, FOCUS_DOWN,
        ...
        protected boolean isCandidateSelection(int childIndex, int direction) {
            ...
            switch (direction) {
                case View.FOCUS_RIGHT:
                    // coming from left, selection is only valid if it is on
                    // left
                    // edge
    ...
    private class HorizontalGridBuilder extends GridBuilder {
        ...
        protected void fillGap(boolean right) {
            ...
            if (right) {
                final int startOffset = count > 0 ? getChildAt(count - 1).getRight() + horizontalSpacing
                        : getListPaddingLeft();
                int position = mFirstPosition + count;
                if (mStackFromBottom) {
                    position += numRows - 1;
                ...
                final int startOffset = count > 0 ? getChildAt(0).getLeft() - horizontalSpacing : getWidth()
                        - getListPaddingRight();
                int position = mFirstPosition;
                if (!mStackFromBottom) {
                    position -= numRows;
         ...
         * 
         * @param pos The first position to put in the list
         * @param nextLeft The location where the left of the item associated
        ...
        private View fillRight(int pos, int nextLeft) {
            if (DEBUG)
                Debug.d(TAG, "fillRight() pos: " + pos + " nextLeft: " + nextLeft + " mFirstPosition: " + mFirstPosition);
            View selectedView = null;
        ...
        private View makeColumn(int startPos, int x, boolean flow) {
            if (DEBUG)
                Debug.d(TAG, "makeColumn() startPos: " + startPos + " x: " + x + " flow: " + flow + " mFirstPosition: "
                        + mFirstPosition);
        ...
        private View fillLeft(int pos, int nextRight) {
            if (DEBUG)
                Debug.d(TAG, "fillLeft() pos: " + pos + " nextRight: " + nextRight + " mFirstPosition: " + mFirstPosition);
            View selectedView = null;
         ...
         * 
         * @param nextLeft The location where the left of the first item should
         *            be drawn
         * @return The view that is currently selected
         */
        private View fillFromTop(int nextLeft) {
            if (DEBUG)
                Debug.d(TAG, "fillFromTop() nextLeft: " + nextLeft + " mFirstPosition: " + mFirstPosition);
            mFirstPosition = Math.min(mFirstPosition, mSelectedPosition);
            mFirstPosition = Math.min(mFirstPosition, mItemCount - 1);
            if (mFirstPosition < 0) {
                mFirstPosition = 0;
        ...
        private View fillFromBottom(int lastPosition, int nextRight) {
            if (DEBUG)
                Debug.d(TAG, "fillFromBotom() lastPosition: " + lastPosition + " nextRight: " + nextRight
                        + " mFirstPosition: " + mFirstPosition);
            lastPosition = Math.max(lastPosition, mSelectedPosition);
            lastPosition = Math.min(lastPosition, mItemCount - 1);
        ...
        private View fillSelection(int childrenLeft, int childrenRight) {
            if (DEBUG)
                Debug.d(TAG, "fillSelection() childrenLeft: " + childrenLeft + " childrenRight: " + childrenRight
                        + " mFirstPosition: " + mFirstPosition);
            final int selectedPosition = reconcileSelectedPosition();
            final int numRows = mNumRows;
            final int horizontalSpacing = mHorizontalSpacing;
            ...
            if (!mStackFromBottom) {
                ...
                final int rightSelectionPixel = getRightSelectionPixel(childrenRight, fadingEdgeLength, numRows,
                        columnStart);
        ...
        private View fillSpecific(int position, int left) {
            if (DEBUG)
                Debug.d(TAG, "fillSpecific() position: " + position + " left: " + left + " mFirstPosition: "
                        + mFirstPosition);
            final int numRows = mNumRows;
        ...
        private void correctTooLeft(int numRows, int horizontalSpacing, int childCount) {
            if (DEBUG)
                Debug.d(TAG, "correctTooLeft() numRows: " + numRows + " horizontalSpacing: " + horizontalSpacing
                        + " mFirstPosition: " + mFirstPosition);
            // First see if the last item is visible
            final int lastPosition = mFirstPosition + childCount - 1;
            if (lastPosition == mItemCount - 1 && childCount > 0) {
                ...
                if (rightOffset > 0 && (mFirstPosition > 0 || firstLeft < mListPadding.left)) {
                    ...
                    if (mFirstPosition > 0) {
                        ...
                        // possible
                        fillLeft(mFirstPosition - (mStackFromBottom ? 1 : numRows), firstChild.getLeft()
                                - horizontalSpacing);
                        // Close up the remaining gap
                        adjustViewsLeftOrRight();
                    }
        ...
        private void correctTooRight(int numRows, int horizontalSpacing, int childCount) {
            if (DEBUG)
                Debug.d(TAG, "correctTooRight() numRows: " + numRows + " horizontalSpacing: " + horizontalSpacing
                        + " mFirstPosition: " + mFirstPosition);
            if (mFirstPosition == 0 && childCount > 0) {
                // Get the first child ...
                final View firstChild = getChildAt(0);
                ...
                if (leftOffset > 0 && (lastPosition < mItemCount - 1 || lastRight > end)) {
                    ...
                    if (lastPosition < mItemCount - 1) {
                        ...
                        fillRight(lastPosition + (!mStackFromBottom ? 1 : numRows), lastChild.getRight()
                                + horizontalSpacing);
                        // Close up the remaining gap
                        adjustViewsLeftOrRight();
                    }
        ...
        private View moveSelection(int delta, int childrenLeft, int childrenRight) {
            if (DEBUG)
                Debug.d(TAG, "moveSelection() delta: " + delta + " childrenLeft: " + childrenLeft + " childrenRight: "
        ...
        protected void layoutChildren() {
            ...
            switch (mLayoutMode) {
                ...
                case LAYOUT_MOVE_SELECTION:
                    ...
                    if (mAdapter != null && mAdapter.getCount() - mSelectedPosition >= mNumColumns / 2
                            && mAdapter.getCount() != mNumColumns) {
                        sel = moveSelection(delta, childrenRight / 2, childrenRight / 2);
                    } else {
                        sel = moveSelection(delta, childrenLeft, childrenRight);
                    }
                    // eostek patch end
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int heightSize = MeasureSpec.getSize(heightMeasureSpec);
            if (DEBUG)
                Debug.d(TAG, "horizontal onMeasure heightMode: " + heightMode);
            if (heightMode == MeasureSpec.UNSPECIFIED) {
                if (mRowHeight > 0) {
            ...
            if (count > 0) {
                ...
                int childWidthSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(0, MeasureSpec.EXACTLY), 0,
                        p.width);
                child.measure(childWidthSpec, childHeightSpec);
            ...
            mWidthMeasureSpec = widthMeasureSpec;
            if (DEBUG)
                Debug.d(TAG, "Horizontal onMeasure widthSize: " + widthSize + " heightSize: " + heightSize);
        }
        ...
        private void determineRows(int availableSpace) {
            ...
            if (DEBUG)
                Debug.d(TAG, "determineRows() mRowHeight: " + mRowHeight + " mVerticalSpacing: " + mVerticalSpacing
        ...
        private View fillFromSelection(int selectedLeft, int childrenLeft, int childrenRight) {
            if (DEBUG)
                Debug.d(TAG, "fillFromSelection() selectedLeft: " + selectedLeft + " childrenLeft: " + childrenLeft
                        + " childrenRight: " + childrenRight + " mFirstPosition: " + mFirstPosition);
            final int fadingEdgeLength = getHorizontalFadingEdgeLength();
            final int selectedPosition = mSelectedPosition;
            final int numRows = mNumRows;
            final int horizontalSpacing = mHorizontalSpacing;
         ...
         * @param childInSelectedRow A child in the row that contains the
         *            selection
         * @param leftSelectionPixel The leftmost pixel we can draw the
         *            selection into
         ...
         * @param where Where to add the item in the list
         */
        private void setupChild(View child, int position, int x, boolean flow, int childrenTop, boolean selected,
                boolean recycled, int where) {
            boolean isSelected = selected && shouldShowSelector();
            final boolean updateChildSelected = isSelected != child.isSelected();
            final int mode = mTouchMode;

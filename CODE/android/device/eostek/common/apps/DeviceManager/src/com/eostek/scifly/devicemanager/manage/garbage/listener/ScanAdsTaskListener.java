...
public class ScanAdsTaskListener implements BaseTaskListener {
    private static final String TAG = "ScanAdsTaskListener";

    private Handler mhandler;

    public ScanAdsTaskListener(Handler mhandler) {
        super();
    ...
    public void onTaskCompleted(FileCollection collection) {
        ...
        msg.setData(data);
        msg.what = Constants.GARBAGE_MSG_ADS_AVAILABLE;

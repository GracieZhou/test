...
public class MedianCutQuantizer {
    ...
    private static final String TAG = MedianCutQuantizer.class.getSimpleName();
    ...
    public static class ColorNode {
        ...
        public String toString() {
            return new StringBuilder(getClass().getSimpleName()).append(" #").append(Integer.toHexString(getRgb()))
    ...
    enum ColorDimension {
        RED(new redComparator()), GREEN(new grnComparator()), BLUE(new bluComparator());
    ...
    void listColorNodes(ColorNode[] nodes) {
        ...
        for (ColorNode color : nodes) {
            Debug.d(TAG, "Color Node #" + i + " " + color.toString());
            i++;
        }
    }

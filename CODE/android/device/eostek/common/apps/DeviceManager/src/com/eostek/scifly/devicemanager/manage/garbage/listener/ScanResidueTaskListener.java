...
public class ScanResidueTaskListener implements BaseTaskListener {
    private static final String TAG = "ScanUninstallTaskListener";

    private Handler mhandler;

    public ScanResidueTaskListener(Handler mhandler) {
        super();
    ...
    public void onTaskCompleted(FileCollection collection) {
        ...
        msg.setData(data);
        msg.what = Constants.GARBAGE_MSG_UNINSTALL_AVAILABLE;

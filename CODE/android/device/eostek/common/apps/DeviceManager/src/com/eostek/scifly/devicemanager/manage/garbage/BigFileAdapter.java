...
public class BigFileAdapter extends BaseAdapter {
    ...
    public BigFileAdapter(final Context context, final List<BigFileInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = minflater.inflate(R.layout.act_manage_garbage_big_file_grid_item, null);
            viewHolder.mCheckBox = (CheckBox) convertView.findViewById(R.id.cb_big_file);
            viewHolder.mImageView = (ImageView) convertView.findViewById(R.id.iv_big_file);
	...
	private void bindView(ViewHolder viewHolder, BigFileInfo bigFileInfo) {
		if (bigFileInfo == null) {
			return;
		}
		if (isShow) {

...
public class CircleBar extends View {
    ...
    private int progressStrokeWidth = 33;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(x + width / 2, y + height / 2, height / 2 - progressStrokeWidth, paint);

        paint.setAntiAlias(true); // 设置画笔为抗锯齿
        paint.setColor(R.color.circle_bg);
        ...
        paint.setColor(Color.rgb(23, 177, 179));// Color.rgb(0x57, 0x87,
                                                // 0xb6)rgb(23, 177, 179)
        ...
        canvas.drawText(text + "%", width / 2 - textWidth * 4 / 5, height * 1 / 2 + 20, paint);

        // paint.setTextSize(textHeight / 2);
        // canvas.drawText("%", width * 3 / 5, height * 1/2+20, paint);

        // try {
        // canvas.drawText("nei cun ", width / 4, height * 2 / 3, paint);
        // } catch (Exception e) {
        // e.printStackTrace();

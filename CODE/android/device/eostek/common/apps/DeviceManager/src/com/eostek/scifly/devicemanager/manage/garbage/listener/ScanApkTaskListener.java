...
public class ScanApkTaskListener implements BaseTaskListener {
    private static final String TAG = "ScanInvalidTaskListener";

    private Handler mhandler;

    public ScanApkTaskListener(Handler mhandler) {
        super();
    ...
    public void onTaskCompleted(FileCollection collection) {
        ...
        msg.setData(data);
        msg.what = Constants.GARBAGE_MSG_APK_AVAILABLE;

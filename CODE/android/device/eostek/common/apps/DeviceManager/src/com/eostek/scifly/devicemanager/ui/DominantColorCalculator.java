...
import com.eostek.scifly.devicemanager.ui.MedianCutQuantizer.ColorNode;
...
public class DominantColorCalculator {
    ...
    private void findColors() {
        ...
        final int tertiaryAccentColor = findTertiaryAccentColor(primaryAccentColor, secondaryAccentColor);
        ...
        mColorScheme = new ColorScheme(primaryAccentColor.getRgb(), secondaryAccentColor.getRgb(), tertiaryAccentColor,

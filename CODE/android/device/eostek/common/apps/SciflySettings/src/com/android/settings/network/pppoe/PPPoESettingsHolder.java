...
public class PPPoESettingsHolder {
    ...
    public PPPoESettingsHolder(View view) {
        this.mView = view;
        findViews();
    }

    private void findViews() {
        mPPPoESettingsRootLayout = (LinearLayout) mView.findViewById(R.id.pppoe_setting_ll);
        mConnectTypeLayout = (RelativeLayout) mView.findViewById(R.id.pppoe_auto_ip_rl);
        mConnectTypeButton = (Button) mView.findViewById(R.id.pppoe_auto_ip);
        ...
        mUserEditText = (EditText) mView.findViewById(R.id.username_et);
        mPasswdEditText = (EditText) mView.findViewById(R.id.password_et);
        // show passwd
        mShowPasswdLayout = (RelativeLayout) mView.findViewById(R.id.show_password_rl);
        mShowPasswdCheckBox = (CheckBox) mView.findViewById(R.id.show_password);
        ...
        mShowPasswdCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    mPasswdEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                }
            }
        });

        // auto dial
        mAutoDialLayout = (RelativeLayout) mView.findViewById(R.id.auto_dialer_rl);
        mAutoDialCheckBox = (CheckBox) mView.findViewById(R.id.auto_dialer_cb);
        ...
        // connect status type
        mStatusTextView = (TextView) mView.findViewById(R.id.dialer_status);
        // handup and dail button
        mHangupButton = (Button) mView.findViewById(R.id.dialer_hangup);
        ...
        mDialButton = (Button) mView.findViewById(R.id.dialer_ok);

...
public class UsageBarPreference extends Preference {
    ...
    public UsageBarPreference(Context context, boolean flag) {
        super(context);
        this.flag = flag;
        this.mContext = context;
        setLayoutResource(R.layout.preference_memoryusage);
    ...
    protected void onBindView(View view) {
        ...
        if (flag) {
            mChart.setBackgroundColor(mContext.getResources().getColor(R.color.extension_memory_avail));
        }
    }

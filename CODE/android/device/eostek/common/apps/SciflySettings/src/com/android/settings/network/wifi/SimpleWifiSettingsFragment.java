 ...
 * wififragment
 */
public class SimpleWifiSettingsFragment extends PreferenceFragment implements AccessPoint.OnKeyDownListener {

    protected static final String TAG = "WifiSettingsfragment";

    private SimpleWifiSettingsLogic mLogic;
    ...
    public void onActivityCreated(Bundle arg0) {
        ...
        mLogic = new SimpleWifiSettingsLogic(getActivity(), this, mSetupWizardMode);
    ...
    private class ConfirmClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            if (mPasswordDialog != null && mPasswordDialog.isShowing()) {
                if (mPasswordDialog.getDialogType() == "INPUT_PASSWORD") {
                    mLogic.mWifiManagerGlobal.connect(mPasswordDialog.getConfig(), mLogic.mConnectListener);
                    mPasswordDialog.dismiss();
                } else if (mPasswordDialog.getDialogType() == "ADD_WIFI") {
                    String password = "";

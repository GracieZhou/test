...
public class ConnectionHolder {
    ...
    private void setTitleWidget() {
        ...
        if (tw != null) {
            tw.setSubTitleText(mConnectionActivity.getString(R.string.network_settings),
                    mConnectionActivity.getString(R.string.network_diag));
        }
    }

    private void showStaticInfo() {
        IpConfig ipConfig = mConnectionLogic.getIpConfig();
        ...
        if (staticIpConfig != null) {
            if (staticIpConfig.ipAddress != null) {
                mIpAddressTv.setText(staticIpConfig.ipAddress.getAddress().getHostAddress());
            }
            if (staticIpConfig.gateway != null) {
                mGatewayAddressTv.setText(staticIpConfig.gateway.getHostAddress());
            }

            mAccessWayTv.setText(ipConfig.ipAssignment == IpAssignment.DHCP ? "DHCP" : "STATIC");
        } else {
            mIpAddressTv.setText("0.0.0.0");
            mGatewayAddressTv.setText("0.0.0.0");
            mAccessWayTv.setText(mConnectionActivity.getResources().getString(R.string.unassigned));
        }
    }
            ...
            public void onClick(View v) {
                ...
                mConnReturnBtn.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mConnectionActivity.overridePendingTransition(R.anim.fade_out_left, R.anim.fade_out);
                    }
                });

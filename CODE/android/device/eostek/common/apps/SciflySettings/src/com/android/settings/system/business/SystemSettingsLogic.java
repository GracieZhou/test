    ...
    public String getCurrentInputMethodName() {
        String lastInputMethodId = Settings.Secure.getString(mActivity.getContentResolver(),
                Settings.Secure.DEFAULT_INPUT_METHOD);
                 Log.d("tag", "<<<<<<<lastInputMethodId<<<<<<<<<<<<" + lastInputMethodId);
    ...
    public String getInstallLocation() {
        ...
        switch (installLocationPreference) {
            case INSTALL_LOCATION_AUTO:
                ...
                break;
            case INSTALL_LOCATION_UDISK:
                if (!mActivity.isHasUDisk()) {
                    Settings.Global.putInt(mActivity.getContentResolver(), Global.DEFAULT_INSTALL_LOCATION,
                            INSTALL_LOCATION_AUTO);
                    appInstallLocation = mActivity.getString(R.string.install_location_auto);
                } else {
                    appInstallLocation = mActivity.getString(R.string.install_location_usb);
                }
                break;
        }

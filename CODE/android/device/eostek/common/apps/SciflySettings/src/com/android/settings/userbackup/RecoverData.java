...
public class RecoverData extends BroadcastReceiver {
    ...
    private static String mInputMethodId = null;
    ...
    public boolean reData(Context mContext) {
        ...
        // recover inputmethod id
        mInputMethodId = getValue("inputmethod", "inputmethod_id");
        if (!"".equals(mInputMethodId) && mInputMethodId != null && !mInputMethodId.equals("none")) {

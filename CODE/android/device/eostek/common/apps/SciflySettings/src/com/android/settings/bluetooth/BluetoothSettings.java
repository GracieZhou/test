...
public class BluetoothSettings extends DeviceListPreferenceFragment {
    ...
    private void updateContent(int bluetoothState, boolean scanState) {
        ...
        switch (bluetoothState) {
            ...
            case BluetoothAdapter.STATE_TURNING_OFF:
                mBluetoothCheckBox.setChecked(false);
                mBluetoothCheckBox.setEnabled(false);
                break;
    ...
    void onOtherPreferenceClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mBluetoothCheckBox) {

...
public class NtpServerAdapter extends BaseAdapter {

    private List<HashMap<String, Object>> mList = new ArrayList<HashMap<String, Object>>();

    private LayoutInflater mInflater;

    public NtpServerAdapter(Activity activity, ArrayList<HashMap<String, Object>> list) {
        this.mList = list;
    ...
    public void setCurrentNtpserver(int defaultNtpserverId) {
        mCurrentNtpserver = defaultNtpserverId;
    }

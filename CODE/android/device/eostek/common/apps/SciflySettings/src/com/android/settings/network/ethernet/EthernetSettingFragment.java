 ...
 */
public class EthernetSettingFragment extends PreferenceFragment implements OnPreferenceClickListener,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mEthernetSettingLogic = mActivity.getEthernetSettingLogic();
        mEthernetSettingLogic.processInfo();
        // find preference
        ...
        mEthernetPreference.setChecked(mEthernetSettingLogic.mEthernetManagerGlobal.isEnabled());
        isRemovePreference(!mEthernetSettingLogic.mEthernetManagerGlobal.isEnabled());
        // set contains of preference
        mAutoPreference.setOnPreferenceChangeListener(this);
        // set contains of preference
        initViews();
        changItemBackground(mEthernetSettingLogic.isAutoGetIp);
        Log.d(TAG, "<<<<<<<mEthernetSettingLogic.isAutoGetIp<<<<<<<<<" + mEthernetSettingLogic.isAutoGetIp);
    }
    ...
    public void showInputDialog(String key) {
        ...
        if (ETHERNET_SWITCH.equals(key)) {
            ...
            mEthernetSettingLogic.mEthernetManagerGlobal.setEnabled(mEthernetPreference.isChecked());
            isRemovePreference(!mEthernetPreference.isChecked());
        }
        if (IPADRESS.equals(key)) {
            LinkPropertyInputDialog dialog = new LinkPropertyInputDialog(((NetworkSettingActivity) getActivity()),
                    ((NetworkSettingActivity) getActivity()).getEthernetSettingLogic().mIpStr);
            dialog.show();
            ...
            dialog.setPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void onPropertyChange(String value) {
                    ...
                    try {
                        ...
                        if (inetAddr != null) {
                            mEthernetSettingLogic.mIpStr = value;
        ...
        if (MASK.equals(key)) {
            LinkPropertyInputDialog dialog = new LinkPropertyInputDialog((NetworkSettingActivity) getActivity(),
                    ((NetworkSettingActivity) getActivity()).getEthernetSettingLogic().mSubnetMaskStr);
            dialog.show();
            ...
            dialog.setPropertyChangeListener(new PropertyChangeListener() {
                public void onPropertyChange(String value) {
                    ...
                    if (NetworkSettingUtils.isValidMaskString(value)) {
                        mEthernetSettingLogic.mSubnetMaskStr = value;
        ...
        if (GATEWAY.equals(key)) {
            LinkPropertyInputDialog dialog = new LinkPropertyInputDialog((NetworkSettingActivity) getActivity(),
                    ((NetworkSettingActivity) getActivity()).getEthernetSettingLogic().mGatewayStr);
            dialog.show();
            ...
            dialog.setPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void onPropertyChange(String value) {
                    ...
                    try {
                        ...
                        if (gatewayAddr != null) {
                            mEthernetSettingLogic.mGatewayStr = value;
        ...
        if (DNS.equals(key)) {
            LinkPropertyInputDialog dialog = new LinkPropertyInputDialog(((NetworkSettingActivity) getActivity()),
                    ((NetworkSettingActivity) getActivity()).getEthernetSettingLogic().mDnsStr);
            dialog.show();
            ...
            dialog.setPropertyChangeListener(new PropertyChangeListener() {
                ...
                public void onPropertyChange(String value) {
                    ...
                    try {
                        ...
                        if (dnsAddr != null) {
                            mEthernetSettingLogic.mDnsStr = value;
    ...
    private void initViews() {
        if (mEthernetSettingLogic.isAutoGetIp) {
        ...
        Log.d(TAG, "<mIpStr<<<<<<<<<<<<<<" + mEthernetSettingLogic.mIpStr);
        Log.d(TAG, "<mSubnetMaskStr<<<<<<<<<<<<<<" + mEthernetSettingLogic.mSubnetMaskStr);
        Log.d(TAG, "<mGatewayStr<<<<<<<<<<<<<<" + mEthernetSettingLogic.mGatewayStr);
        Log.d(TAG, "<mDnsStr<<<<<<<<<<<<<<" + mEthernetSettingLogic.mDnsStr);
        mIpPreference.setRightText(mEthernetSettingLogic.mIpStr);
        mMaskPreference.setRightText(mEthernetSettingLogic.mSubnetMaskStr);
        mGatePreference.setRightText(mEthernetSettingLogic.mGatewayStr);
        mDnsPreference.setRightText(mEthernetSettingLogic.mDnsStr);
    }
    ...
    public boolean onPreferenceChange(Preference arg0, Object newValue) {
        if (AUTO_KEY.equals(arg0.getKey())) {
            ...
            if (newValue.equals(strArray[0])) {
                mEthernetSettingLogic.isAutoGetIp = true;
            } else if (newValue.equals(strArray[1])) {
                mEthernetSettingLogic.isAutoGetIp = false;
            }
            changItemBackground(mEthernetSettingLogic.isAutoGetIp);
        }
        return true;
    ...
    public void onPause() {
        super.onPause();
        mEthernetSettingLogic.saveEthernetConfig();
    }

...
public final class BluetoothDevicePreference extends Preference implements
    ...
    private void askUnpair(){
    	Context context = getContext();
    	String title = context.getString(R.string.bluetooth_unpair_title);
        String message = context.getString(R.string.bluetooth_unpair_message);
        DialogInterface.OnClickListener unPairListener =
                new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
            	mCachedDevice.unpair();
            }
        };
        mUnpairDialog = Utils.showUnPairDialog(context,
        		mUnpairDialog, unPairListener, title,message);
    }

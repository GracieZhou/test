...
interface ITvTimer {
    ...
    boolean setOnTimer(in StandardTime time);
    StandardTime getOnTimer();
    boolean setOnTimeEvent(in OnTimeTvDescriptor stEvent);
    OnTimeTvDescriptor getOnTimeEvent();
    boolean setOnTimerEnable(boolean bEnable);
    boolean isOnTimerEnable();
    boolean setOffTimer(in StandardTime time);
    StandardTime getOffTimer();
    boolean setOffTimerEnable(boolean bEnable);
    boolean isOffTimerEnable();
    boolean setSleepMode(in int eMode);
    boolean setSleepTimeInMins(in int minutesTime);
    int getSleepTimeRemainMins();
    int getSleepMode();
    int getTimeZone();
    void setTimeZone(in int zone,boolean isSaved);
    void updateTimeZone();
    int getRtcClock();
    int getClockOffset();
    void setClkTime(long time,boolean isSave);
    boolean setAutoSync(boolean bSync);
    void setDaylightSavingState(boolean flag);
    boolean getDaylightSavingState();
    EpgEventTimerInfo getEpgTimerEventByIndex(int index);
    int getEpgTimerEventCount();
    int addEpgEvent(in EpgEventTimerInfo vo);
    boolean delEpgEvent(int epgEvent);
    boolean isEpgScheduleRecordRemiderExist(int secondsFromNow);
    boolean delAllEpgEvent();
    void cancelEpgTimerEvent(int timeActing, boolean checkEndTime);
    EpgEventTimerInfo getEpgTimerRecordingProgram();
    int isEpgTimerSettingValid(in EpgEventTimerInfo timerInfoVo);
    ...
    void setDaylightSavingMode(int mode);

    //EosTek Patch Begin
    boolean setSleepTimeModeOff();
    //EosTek Patch End
}

...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= $(ATTACH_PRODUCT)/bluetooth
...
BOARD_EGL_CFG := $(ATTACH_PRODUCT)/egl.cfg
...
TARGET_RECOVERY_FSTAB :=  $(LOCAL_PATH)/fstab.monet
...
# utopia/tvapi path
TARGET_UTOPIA_LIBS_DIR := $(ATTACH_PRODUCT)/libraries/utopia

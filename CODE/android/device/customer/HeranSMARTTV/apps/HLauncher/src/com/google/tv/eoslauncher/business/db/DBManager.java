...
package com.google.tv.eoslauncher.business.db;
    ...
    public List<AppInfoBean> getAppInfoBeans() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                infoBean.setDownloadUrl(cursor.getString(cursor
                        .getColumnIndex(DBHelper.APPLICATION_COLUMN_DOWNLOAD_URL)));
                infoBean.setPackageName(cursor.getString(cursor
                        .getColumnIndex(DBHelper.APPLICATION_COLUMN_PACKAGE_NAME)));

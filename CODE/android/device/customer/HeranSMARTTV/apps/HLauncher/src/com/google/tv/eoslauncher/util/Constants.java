...
public class Constants {
    public static final String jowinwinUrl ="http://www.jowinwin.com/hertv2msd/ad_test.php";
    ...
    public static final String MEDIA_BROWSER_PK_NAME = "com.eostek.mediabrowser";
    
    public static final String MEDIA_BROWSER_CLASS = "com.eostek.mediabrowser.MainActivity";
    ...
    public final static int SET_SMALL_SCALE = 0x19;
    
    public static final int FINISH_BOOT_AD = 0x1a;
    ...
    public final static int NETWORK_READ_DATA_TIMEOUT = 10 * 1000;

...
import com.google.tv.eoslauncher.model.BackendFunctionSwitch;
...
public class HistoryRec {
    ...
    public static String[] block = {"1", /* 首頁  */
        							"2", /* App 頁 */
        							"3", /* 多媒體頁 */
        							"4", /* 商店 */
        							"5", /*潘朵拉*/
									...
									"7"}; /*開關機時間*/
    // Home Fragment
    public static String[] block1Action = {"10",   /* atv 轉台 */  
                                           "11",   /* dtv 轉台 */
                                           "12",   /* unknow 轉台*/ 
                                           "13",   /* 廣告點擊  */
                                           "14"};  /* 點擊全螢幕播放*/   
    // App Fragment
    public static String[] block2Action = {"20",  /* 點擊左上方廣告頁 */   
                                           "21",  /* 點擊左中的 App GridView */
                                           "22",  /* 點擊右中的 GridView */
                                           "23",  /* 點擊 All App 頁面中的 app*/
                                           "24"}; /* 點擊右上setting */
    // MediaFragment
    public static String[] block3Action = {"30",  /* 點擊卡拉ok圖示 */   
                                           "31",  /* 點擊影片圖示 */
                                           "32",  /* 點擊圖片圖示 */
                                           "33"}; /* 點擊音樂圖示 */
    // ShopFragment
    public static String[] block4Action = {"40",  /* 點擊左方廣告 */   
                                           "41",  /* 點擊右上廣告*/
                                           "42"}; /* 點擊會員系統 */

    // PandoraFragment
    public static String[] block5Action = {"50",  /* 永久關閉 Pandora */   
    									   "51",  /* 離開潘朵拉*/
    									   "52"}; /* 進入潘朵拉 */	
    //開機廣告
    public static String[] block6Action ={};
    
    public static String[] block7Action={"70",  /*開機時間*/
    									 "71"}; /*關機時間*/
...
//        DateTime = new StringBuilder().append(String.valueOf(year)).append('-').append(String.valueOf(month)).append("-")
    ...
    public static void UploadFiles(final String PathFile) {
        new Thread() {  
            ...
            public void run() {  
                ...
                HttpPost post = new HttpPost("http://www.launcher-log.jowinwin.com/launcherLog/webservice/upload.php");  //上傳SERVER 訪問網頁路徑
//                HttpPost post = new HttpPost("http://219.87.154.38/launcherLog/webservice/upload.php");  //上傳SERVER 訪問網頁路徑
//                HttpPost post = new HttpPost("http://www.record.jowinwin.com/launcherLog/webservice/upload.php");  //上傳SERVER 訪問網頁路徑
//                HttpPost post = new HttpPost("http://www.tads.jowinwin.com/FGRecord/webservice/upload.php");  //上傳SERVER 訪問網頁路徑                
                try{
                    ...
                    for(int i=0;i< params.size();i++){
                        ...
                        if(params.get(i).getName().equals("file")){
                            ...
                            entity.addPart("image" + i,fileBody);  // image這字串 會根據01.php修改
                            Log.d(TAG, "image");
                        }else{
                            Log.e(TAG, "2");
    ...
    public static void GetFetchTime() {
        new Thread() {  
            ...
            public void run() {  
                ...
                HttpClient client = new DefaultHttpClient();
//                HttpPost post = new HttpPost("http://launcher-log.jowinwin.com//webservice/schedule.php");
                HttpPost post = new HttpPost("http://www.launcher-log.jowinwin.com/launcherLog/webservice/schedule.php");                
                try{
                    ResponseHandler<String> handler = new BasicResponseHandler();
    ...
    public static void Get_Rec(final String AD_Download) {
        new Thread() { 
...
//                String url = "http://www.jowinwin.com/tedswitch/aw.php?mac=" + MacAddr;  // 測試該 api 不存在              
                ...
                try{
                    ...
                    if (AD_Download.equals("Rec_upDate")) {
                        ...
                        if (HistoryRec.BFS.get(6).functionStatus) {
                            ...
                            DownloadAD Down = new DownloadAD();
                            Down.execute();
                        }
                    ...
                    Log.d(TAG, "ClientProtocolException e = " + e.getMessage().toString());
                } catch (IOException e) {
                    Log.d(TAG, "IOException e = " + e.getMessage().toString());
                } catch (JSONException e) {
                    Log.d(TAG, "JSONException e = " + e.getMessage().toString());
                } catch (NumberFormatException e) {
                    Log.d(TAG, "NumberFormatException e = " + e.getMessage().toString());
                } finally{ // 讀不到資料 , 來個預設值
                    if(BFS == null) {

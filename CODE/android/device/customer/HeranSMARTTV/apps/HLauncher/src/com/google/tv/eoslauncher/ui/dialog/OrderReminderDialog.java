...
public class OrderReminderDialog extends AlertDialog {
    ...
    private com.google.tv.eoslauncher.ui.dialog.FocusView focusView;
    ...
    private void init() {
        ...
        focusView = (com.google.tv.eoslauncher.ui.dialog.FocusView) findViewById(R.id.focus_selector);
        int count = 0;
        try {

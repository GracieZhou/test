...
public class ChannelEditlistAdapter extends BaseAdapter {
    private final String TAG = "ChannelEditlistAdapter";
    ...
    public ChannelEditlistAdapter(ChannelListEditActivity context, List<ProgramInfo> channelList) {
        mContext = context;
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            ...
            arg1 = mLayoutInflater.inflate(R.layout.eos_channel_edit_list_item, null);
        ...
        if (mContext.isMove() && position == mContext.getMoveIndex()) {

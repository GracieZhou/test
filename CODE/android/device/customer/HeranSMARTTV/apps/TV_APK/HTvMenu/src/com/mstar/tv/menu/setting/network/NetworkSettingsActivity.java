    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_MENU:
                Intent mIntent = new Intent(NetworkSettingsActivity.this,EosCustomSettingActivity.class);
        ...
        Tools.logd(TAG, "mFocusIsRight : " + mIsFocusRight + ",mCurrentPosition : " + mCurrentPosition);
        // dispatch key event to Settings
        if (mIsFocusRight) {
            boolean flag = dispatchKeyEvent(keyCode, event);
            Tools.logd(TAG, "dispatchKeyEvent return " + flag);
            ...
            if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
                Tools.logd(TAG, "KeyEvent.KEYCODE_DPAD_RIGHT");
    ...
    private void swapSelected(int position) {
        ...
        switch (position) {
            case Network_Constants.ETHERNET_SETTINGS:
                ...
                if(mEthernetSettings == null){
                    Log.e("test", "mEthernetSettings == null");
                }

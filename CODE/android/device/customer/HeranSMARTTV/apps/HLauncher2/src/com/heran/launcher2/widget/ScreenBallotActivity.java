...
import com.heran.launcher2.util.AnimatedSelector;
...
public class ScreenBallotActivity extends Activity {
    ...
    private int[] screenBallot_img = {
            R.drawable.home, R.drawable.data,R.drawable.app, R.drawable.heran
    };
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                case MKeyEvent.KEYCODE_MSTAR_REVEAL:
                    ...
                    if (activityName.equals("com.heran.launcher2.widget.ScreenBallotActivity")) {

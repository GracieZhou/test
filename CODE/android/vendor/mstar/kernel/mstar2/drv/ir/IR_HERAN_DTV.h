...
//    IRKEY_DASH              = 0x4E,
    IRKEY_SLEEP             = 0x52,
    IRKEY_EPG               = 0x49,
    IRKEY_PIP               = IRKEY_DUMY-4,

  	IRKEY_MIX               = IRKEY_DUMY-3,
    IRKEY_INDEX             = 0x18,
    IRKEY_HOLD              = IRKEY_DUMY-2,
    IRKEY_PREVIOUS          = 0x5E,
    IRKEY_NEXT              = 0x59,
    IRKEY_BACKWARD          = 0x14,
    IRKEY_FORWARD           = 0x15,
...
#define IR_EVENT_TIMEOUT  180//160
#endif

...
function setpaths()
{
    ...
    if [ -n "$MSTAR_TVOS_TOOLCHAIN_PATH" ] ; then
        export PATH=${PATH/$MSTAR_TVOS_TOOLCHAIN_PATH/}
    fi
    ...
    # MStar Android Patch Begin
    unset ARM_NONE_LINUX_GNUEABI_TOOLCHAIN
    unset MSTAR_TVOS_TOOLCHAIN_PATH
    case $ARCH in
        arm64|arm)
            toolchaindir=arm/arm-2012.09/bin
            if [ -d "$gccprebuiltdir/$toolchaindir" ]; then
                 ARM_NONE_LINUX_GNUEABI_TOOLCHAIN="$gccprebuiltdir/$toolchaindir:"
                 MSTAR_TVOS_TOOLCHAIN_PATH="$gccprebuiltdir/$toolchaindir:"
            fi
            ;;
        *)
            # No need to set ARM_NONE_LINUX_GNUEABI_TOOLCHAIN for other ARCHs
            ;;
    esac
    export MSTAR_TVOS_TOOLCHAIN_PATH=$MSTAR_TVOS_TOOLCHAIN_PATH
    # MStar Android Patch End
    ...
    # MStar Android Patch Begin
    export PATH=$ANDROID_BUILD_PATHS$MSTAR_TVOS_TOOLCHAIN_PATH$PATH
    # MStar Android Patch End
    ...
    # EosTek Patch Begin
    unset EOSTEK_MST638_ANDROID_TOOLCHAIN
    # This is for 172.16.1.15
    #EOSTEK_MST638_ANDROID_TOOLCHAIN=/tools/arm/arm-2012.09/bin:/tools/arm_eabi-2011.03/bin:/tools/r2-elf-linux-1.3.5.14/bin
    #export PATH=$EOSTEK_MST638_ANDROID_TOOLCHAIN:$PATH                      
    #export JAVA_HOME=/usr/lib/jvm/java-7-openjdk-amd64                                                                              
    #export JRE_HOME=/usr/lib/jvm/java-7-openjdk-amd64/jre                                                                           
    #export JAVADOC_HOME=/usr/lib/jvm/java-7-openjdk-amd64                                                                           
    #export PATH=$JAVA_HOME/bin:$JRE_HOME/bin:$PATH                                                                                  
    #export PATH=/tools/linaro-aarch64_linux-2014.07_835769-patched/install/bin:$PATH  
    
    # This is for 172.23.65.198
    EOSTEK_MST638_ANDROID_TOOLCHAIN=/home/opt/arm-2012.09/bin:/home/opt/arm_eabi-2011.03/bin:/tools/r2-elf-linux-1.3.5.14/bin
    export PATH=$EOSTEK_MST638_ANDROID_TOOLCHAIN:$PATH                      
    export JAVA_HOME=/home/opt/java-7-openjdk-amd64                                                                              
    export JRE_HOME=/home/opt/java-7-openjdk-amd64/jre                                                                           
    export JAVADOC_HOME=/home/opt/java-7-openjdk-amd64                                                                           
    export PATH=$JAVA_HOME/bin:$JRE_HOME/bin:$PATH                                                                                  
    # EosTek Patch End
}
...
function set_ota()
{
     export OTA_INCREMENTAL_FROM=$(get_build_var OTA_INCREMENTAL_FROM)

     export OTA_WIPECACHE=$(get_build_var OTA_WIPECACHE)

     export OTA_WITH_SECURE_BOOT=$(get_build_var BUILD_WITH_SECURE_BOOT)
     export OTA_SECURE_BOOT_KEY_PATH=$(get_build_var TARGET_DEVICE_DIR)/security

     export OTA_WITH_MBOOT=$(get_build_var OTA_WITH_MBOOT)
     export OTA_RELOAD_ENV=$(get_build_var OTA_RELOAD_ENV)

     export OTA_WITH_TV=$(get_build_var OTA_WITH_TV)
     export OTA_TV_IMAGE_PATH=$(get_build_var OTA_TV_IMAGE_PATH)
     export OTA_TV_IMAGE_LIST=$(get_build_var OTA_TV_IMAGE_LIST)
     export OTA_WITH_TVCONFIG=$(get_build_var OTA_WITH_TVCONFIG)
     export OTA_TVCONFIG_IMAGE_PATH=$(get_build_var OTA_TVCONFIG_IMAGE_PATH)
     export OTA_TVCONFIG_IMAGE_LIST=$(get_build_var OTA_TVCONFIG_IMAGE_LIST)
     export OTA_TVCONFIG_DELETE_LIST=$(get_build_var OTA_TVCONFIG_DELETE_LIST)

     export OTA_WITH_TEE=$(get_build_var OTA_WITH_TEE)

     export OTA_WITH_RTPM=$(get_build_var OTA_WITH_RTPM)

     export OTA_WITH_URSA=$(get_build_var OTA_WITH_URSA)
     export OTA_WITH_RAPTORS=$(get_build_var OTA_WITH_RAPTORS)
     export OTA_WITH_DTB=$(get_build_var OTA_WITH_DTB)
}
# MStar Android Patch End
